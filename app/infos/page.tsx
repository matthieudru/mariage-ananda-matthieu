...
export default function Infos() {
  ...
  return (
    <div style={{ background: BG, color: COLOR, fontFamily: "'FT Aktual', Georgia, serif" }}>
      ...
      {/* ── TONNARA ── */}
      <section style={{ borderBottom: `1px solid rgba(36,59,113,0.15)`, display: "grid", gridTemplateColumns: "1fr 40%", minHeight: "100vh" }} className="tonnara-grid">
          ...
          <div style={{ maxWidth: "75%", display: "flex", flexDirection: "column", gap: "20px" }}>
            ...
            >
              <div style={{ position: "relative", width: "100%", paddingBottom: "100%", overflow: "hidden" }}>
                <iframe
                  src="https://maps.google.com/maps?q=38.0604,12.8252&t=&z=14&ie=UTF8&iwloc=B&output=embed"
